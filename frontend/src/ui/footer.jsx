export default function Footer() {
  return (
    <footer className="sticky top-0 left-0 w-full px-6 py-4 sm:px-8 sm:py-6 md:px-12 lg:px-20 xl:px-24 bg-slate-200 dark:bg-black text-black dark:text-white">
