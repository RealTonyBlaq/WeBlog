              ...
              <Form className="w-full max-w-sm mx-auto flex flex-col gap-3 md:gap-4 items-center">
                ...
                <div className="w-full flex items-center justify-center gap-2">
                  ...
                  <button
                    ...
                    className={`w-32 py-2 flex items-center justify-center font-medium bg-red-700 text-white border border-red-700 dark:border-0 rounded-lg ${
                      !isLoading && "hover:bg-white hover:text-red-700"
                    }`}
                  >
                    Cancel
                  </button>
